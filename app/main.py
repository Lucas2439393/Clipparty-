        ...
        try:
            ...
            if (
                ...
                raise HTTPException(
                    status_code=400,
                    detail=(
                        "Video is te lang: maximaal "
                        "60 minuten toegestaan "
            ...
            raise HTTPException(
                status_code=400,
                detail=(
                    f"Video kon niet worden gecontroleerd: {e}"
                ),
            )
...
def start_campaign(
    ...
    # create_job receives the complete request.
